...
seahorse podman-compose sysstat okular gnupg2-scdaemon
```
...
### gdm-password file
we ask for pinverification here and it is sufficient, this rulesout the requirement
for entering password, plus touch.
Instead we use pin verification and touch.
```shell
...
### sudo file
```shell
# add following line at the top of sudo file to allow touch / presence confirmation
